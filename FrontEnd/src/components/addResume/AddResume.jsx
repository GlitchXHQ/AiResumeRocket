...
const AddResume = () => {
  ...
  return (
    <div className='mt-3'>
        <div className='flex flex-col mt-16 justify-center items-center mb-2.5'>
            <Faces/>
            <Content/>
            <div className='mt-6'><p className='text-3xl'>Completely free and customizable for your own purpose.</p></div>
            <Features/>
            <div className='mt-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-5'>
            <Resumes/>
            {
